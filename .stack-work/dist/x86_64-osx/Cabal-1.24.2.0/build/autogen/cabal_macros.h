...
/* package qc-0.1.0.0 */
#define VERSION_qc "0.1.0.0"
#define MIN_VERSION_qc(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "qc-0.1.0.0-76Lrk14yc2o38huUTf5lkJ"

#define CURRENT_PACKAGE_KEY "qc-0.1.0.0-76Lrk14yc2o38huUTf5lkJ"
